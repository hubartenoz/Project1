 ...
 *
 * @author Masked
 * @plugindesc Torna possivel que voce de zoom no mapa durante o jogo.
 * 
 * <MBS MapZoom>
 * @help
 * ===========================================================================
 * Introducao
 * ===========================================================================
 * Esse script permite que voce aumente ou diminua o zoom do jogo quando na 
 * cena do mapa.
 *
 * ===========================================================================
 * Utilizacao
 ...
 * 
 * Troque o X e Y pelos valores de zoom que quiser. Voce pode usar decimais.
 * Note que o "y" e opcional, e se nao for definido o script assumira que seu 
 * valor e igual a X. Se voce quiser, adicione um parametro 'duration' seguido
 * pelo numero de frames que a operacao deve levar, se a duracao nao for 
 * especificada ela sera 60.
 * 
 * Exemplos:
 * MapZoom set 2.0 duration 120
 * MapZoom set 2.0 1.5 duration 20
 *
 * Se voce quiser, pode centralizar a camera do zoom em um evento ou 
 * coordenada usando esse comando:
 *
 * MapZoom center x y
 * MapZoom center event id
 *
 * So troque o 'x' e 'y' ou 'id' pelos valores que quiser.
 * Exemplos:
 * MapZoom center 5 7
 * MapZoom center event 3
 *
 ...
 * MapZoom center reset
 *
 * Voce pode ainda resetar o zoom (mudar para 1.0):
 *
 * MapZoom reset [d]
 *
 * Se quiser, troque o '[d]' pelo numero de frames que quiser que a operacao
 * dure.
 *
 * Exemplos:
 * MapZoom reset 30
 ...
 * como true. Se nao, deixe como false.
 * @default true
 *
 * @param Default zoom
 * @desc Valor padrao para o zoom da tela. Mude isso para aplicar um zoom a 
